...
public class BwaOptions {
	...
	private String headerAlt = "yarn jar --class com.github.bigbwa.BigBWA BigBWA-2.1.jar\n" +
	...
	private void printHelp() {
		...
		System.out.println("BigBWA performs genomic alignment using bwa in a Hadoop/YARN cluster");
	...
	/**
	 * Function to init the BigBWA available options
	 *
